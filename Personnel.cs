...
namespace QLNS
{
    ...
    public class LeaveApplication // chưa biết chưa làm chi tiết
    {
        public int Id { get; set; }
        public DateTime CreatedDate { get; set; }
        public int UserId { get; set; }
    ...
    public class RoleClaims  //chi tiết vai trò
    {
        ...
        public string ClaimType { get; set; } //loại xác nhận quyền sở hữu?????
        public string ClaimValue { get; set; } //giá trị ?????
